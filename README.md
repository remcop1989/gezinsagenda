...
- **Agenda** — maand-, week- en dagweergave, afspraken toevoegen/bewerken, filteren per gezinslid; bij herhalende afspraken kun je kiezen of een wijziging/verwijdering alleen dat ene exemplaar, dit + alle volgende, of de hele reeks raakt. Een afspraak zonder deelnemer krijgt automatisch een eigen filter-chip "Geen deelnemer" (alleen zichtbaar zolang zulke afspraken bestaan), zodat die nooit onbedoeld uit beeld verdwijnt als je de gezinsleden-filters gebruikt. Een kind kan bij een afspraak wel als deelnemer aangevinkt staan (zichtbaar in de agenda) zonder dat de afspraak in diens kindweergave verschijnt (🙈); de week-/dagweergave toont dan een klein 🙈-teken bij die afspraak, zodat dat verschil zichtbaar blijft
- **Kindweergave** — vereenvoudigd overzicht per kind (week/dag)
- **Eigen pictogrammen** — naast de ingebouwde pictogrammenlijst kan bij het aanmaken/bewerken van een afspraak ook een zelfgekozen pictogram (emoji) worden ingevoerd: eenmalig voor die ene afspraak, of blijvend opgeslagen zodat het voortaan ook gewoon in de pictogrammenkiezer staat
